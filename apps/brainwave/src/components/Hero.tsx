...
export function Hero() {
  ...
  return (
    <Section
      ...
      crossesTwd="lg:translate-y-[5.25rem]"
    >
...
const Starter = () => (
  <div
    id="hero/starter"
    className="relative z-1 max-w-5xl mx-auto text-center mb-16 md:mb-20 lg:mb-24"
  >
    ...
    <p className="body-1 max-w-3xl mx-auto mb-6 lg:mb-8 text-n-2">
      Unleash the power of AI within Brainwave. Upgrade your productivity with Brainwave, the open
      AI chat app.
    </p>
    <Button href="/pricing" white className="px-7">
      GET STARTED
    </Button>
  </div>
);
